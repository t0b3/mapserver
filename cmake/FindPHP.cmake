...
if(WIN32)
  ...
  SET(PHP_INCLUDE_PATH "D:/Tools/phpmaster/vc15/x64/php-src")
  SET(PHP_POSSIBLE_INCLUDE_PATHS ${PHP_INCLUDE_PATH})
  if(CMAKE_CL_64)
    #SET(PHP_INCLUDE_PATH "${PHP_INCLUDE_PATH}/$ENV{PLATFORM}")
    SET(PHP_INCLUDE_PATH "${PHP_INCLUDE_PATH}/x64/Release_TS")
    #SET(PHP_INCLUDE_PATH "${D:\Tools\phpmaster\vc15\x64\php-src\x64\Release_TS)
  endif(CMAKE_CL_64)
  if(WITH_THREAD_SAFETY)
    #SET(PHP_INCLUDE_PATH "${PHP_INCLUDE_PATH}/Release_TS")
    SET(PHP_LIBRARY_NAMES php5ts php7ts php8ts)
  ...
  message(STATUS "XXXXPHP_LIBRARY_NAMES: ${PHP_LIBRARY_NAMES}")
  message(STATUS "XXXXPHP_INCLUDE_PATH: ${PHP_INCLUDE_PATH}")
...
message(STATUS "PHP_CONFIG_EXECUTABLE: ${PHP_CONFIG_EXECUTABLE}")
